 ...
 * This provides two sets of functions: the {@code get*} methods, which require an argument to be valid, and {@code opt*}, which accept a
 * default value and return that if the argument was not present or was {@code null}. If the argument is of the wrong type, a suitable error
 * message will be thrown, with a similar format to Lua's own error messages.
 * <h2>Example usage:</h2>
 * <pre>
 * {@code
...
public final class ArgumentHelper {
    ...
    /**
     * Returns a more detailed representation of this number's type. If this is finite, it will just return "number", otherwise it returns
     * whether it is infinite or NaN.
     *
