 ...
 * Be aware that some events (such as {@link TurtleInventoryEvent}) do not necessarily interact with a block, simply objects within that
 * block space.
 */
public abstract class TurtleBlockEvent extends TurtlePlayerEvent {
    ...
    protected TurtleBlockEvent(@Nonnull ITurtleAccess turtle, @Nonnull TurtleAction action, @Nonnull FakePlayer player,
     ...
     * {@code turtle.dig()} command does not fire it.
    ...
    public static class Dig extends TurtleBlockEvent {
        ...
        public Dig(@Nonnull ITurtleAccess turtle, @Nonnull FakePlayer player, @Nonnull World world, @Nonnull BlockPos pos,
                   @Nonnull IBlockState block, @Nonnull ITurtleUpgrade upgrade, @Nonnull TurtleSide side) {
    ...
    public static class Place extends TurtleBlockEvent {
        ...
        public Place(@Nonnull ITurtleAccess turtle, @Nonnull FakePlayer player, @Nonnull World world, @Nonnull BlockPos pos,
    ...
    public static class Inspect extends TurtleBlockEvent {
        ...
        public Inspect(@Nonnull ITurtleAccess turtle, @Nonnull FakePlayer player, @Nonnull World world, @Nonnull BlockPos pos,
                       @Nonnull IBlockState state, @Nonnull Map<String, Object> data) {
