 ...
 * One may use {@link #setCanceled(boolean, String)} to prevent refueling from this specific item. Additionally, you may use
 * {@link #setHandler(Handler)} to register a custom fuel provider.
 */
