...
public interface IPacketNetwork {
    ...
    /**
     * Submit a packet for transmitting across the network. This will route the packet through the network, sending it to all receivers
     * within range (or any interdimensional ones).
     *
