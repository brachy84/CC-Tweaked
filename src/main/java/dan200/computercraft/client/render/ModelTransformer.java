...
public final class ModelTransformer {
    ...
    /**
     * A vertex transformer that tracks whether the normals have been inverted and so the vertices should be reordered so backface culling
     * works as expected.
     */
     ...
     * Equivalent to {@link net.minecraftforge.client.model.pipeline.UnpackedBakedQuad.Builder} but more memory efficient.
