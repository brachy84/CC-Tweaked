...
/**
 * Wraps a {@link dan200.computercraft.core.apis.handles.HandleGeneric} and provides additional methods for getting the response code and
 * headers.
 */
public class HttpResponseHandle implements ILuaObject {
    ...
    public HttpResponseHandle(@Nonnull ILuaObject reader, int responseCode, String responseStatus,
        ...
        newMethods[methodOffset] = "getResponseCode";
