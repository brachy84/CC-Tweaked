...
public class AddressPredicate {
        ...
        for (String filter : filters) {
            ...
            if (cidr >= 0) {
                ...
                try {
                    ...
                    ComputerCraft.log.error("Malformed http whitelist/blacklist entry '{}': Cannot extract IP address from '{}'.", filter,
                                            prefixSizeStr);
                    continue;
                }
     ...
     * This is intended to allow early exiting, before one has to look up the IP address. You should use {@link #matches(InetAddress)}
    ...
    public boolean matches(InetAddress address) {
        ...
        return address instanceof Inet6Address &&
            InetAddresses.is6to4Address((Inet6Address) address) &&
