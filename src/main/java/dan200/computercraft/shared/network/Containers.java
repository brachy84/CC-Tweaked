...
public final class Containers implements IGuiHandler {
    ...
    public static void openComputerGUI(EntityPlayer player, ServerComputer computer) {
        ...
        player.openGui(ComputerCraft.instance, VIEW_COMPUTER, player.getEntityWorld(), computer.getInstanceID(), family.ordinal(),
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (id) {
            case DISK_DRIVE: {
                ...
                if (tile instanceof TileDiskDrive drive) {
            ...
            case COMPUTER: {
                TileEntity tile = world.getTileEntity(pos);
                if (tile instanceof TileComputer computer) {
            ...
            case PRINTER: {
                TileEntity tile = world.getTileEntity(pos);
                if (tile instanceof TilePrinter printer) {
            ...
            case TURTLE: {
                TileEntity tile = world.getTileEntity(pos);
                if (tile instanceof TileTurtle turtle) {
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (id) {
            case DISK_DRIVE: {
                TileEntity tile = world.getTileEntity(pos);
                return tile instanceof TileDiskDrive ? new GuiDiskDrive(new ContainerDiskDrive(player.inventory, (TileDiskDrive) tile)) :
                       null;
            }
            case COMPUTER: {
                TileEntity tile = world.getTileEntity(pos);
