...
public final class CableBounds {
    ...
    private static final EnumMap<EnumFacing, AxisAlignedBB> SHAPE_CABLE_ARM = new EnumMap<>(
        new ImmutableMap.Builder<EnumFacing, AxisAlignedBB>().put(EnumFacing.DOWN, new AxisAlignedBB(MIN, 0, MIN, MAX, MIN, MAX)).put(
            EnumFacing.UP, new AxisAlignedBB(MIN, MAX, MIN, MAX, 1, MAX)).put(EnumFacing.NORTH,
                                                                              new AxisAlignedBB(MIN, MIN, 0, MAX, MAX, MIN)).put(
            EnumFacing.SOUTH, new AxisAlignedBB(MIN, MIN, MAX, MAX, MAX, 1)).put(EnumFacing.WEST,
                                                                                 new AxisAlignedBB(0, MIN, MIN, MIN, MAX, MAX)).put(
            EnumFacing.EAST, new AxisAlignedBB(MAX, MIN, MIN, 1, MAX, MAX)).build());
