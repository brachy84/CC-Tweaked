...
public enum BlockPeripheralVariant implements IStringSerializable {
    DiskDriveEmpty("disk_drive_empty", PeripheralType.DiskDrive), DiskDriveFull("disk_drive_full", PeripheralType.DiskDrive),
    DiskDriveInvalid("disk_drive_invalid", PeripheralType.DiskDrive), PrinterEmpty("printer_empty", PeripheralType.Printer),
    PrinterTopFull("printer_top_full", PeripheralType.Printer), PrinterBottomFull("printer_bottom_full", PeripheralType.Printer),
    PrinterBothFull("printer_both_full", PeripheralType.Printer), WirelessModemOff("wireless_modem_off", PeripheralType.WirelessModem),
    ...
    WirelessModemDownOn("wireless_modem_down_on", PeripheralType.WirelessModem), Monitor("monitor", PeripheralType.Monitor),
    MonitorR("monitor_r", PeripheralType.Monitor), MonitorLR("monitor_lr", PeripheralType.Monitor),
    MonitorL("monitor_l", PeripheralType.Monitor), MonitorD("monitor_d", PeripheralType.Monitor),
    MonitorUD("monitor_ud", PeripheralType.Monitor), MonitorU("monitor_u", PeripheralType.Monitor),
    MonitorRD("monitor_rd", PeripheralType.Monitor), MonitorLRD("monitor_lrd", PeripheralType.Monitor),
    MonitorLD("monitor_ld", PeripheralType.Monitor), MonitorRUD("monitor_rud", PeripheralType.Monitor),
    MonitorLRUD("monitor_lrud", PeripheralType.Monitor), MonitorLUD("monitor_lud", PeripheralType.Monitor),
    MonitorRU("monitor_ru", PeripheralType.Monitor), MonitorLRU("monitor_lru", PeripheralType.Monitor),
    MonitorLU("monitor_lu", PeripheralType.Monitor), MonitorUp("monitor_up", PeripheralType.Monitor),
    MonitorUpR("monitor_up_r", PeripheralType.Monitor), MonitorUpLR("monitor_up_lr", PeripheralType.Monitor),
    MonitorUpL("monitor_up_l", PeripheralType.Monitor), MonitorUpD("monitor_up_d", PeripheralType.Monitor),
    MonitorUpUD("monitor_up_ud", PeripheralType.Monitor), MonitorUpU("monitor_up_u", PeripheralType.Monitor),
    MonitorUpRD("monitor_up_rd", PeripheralType.Monitor), MonitorUpLRD("monitor_up_lrd", PeripheralType.Monitor),
    MonitorUpLD("monitor_up_ld", PeripheralType.Monitor), MonitorUpRUD("monitor_up_rud", PeripheralType.Monitor),
    MonitorUpLRUD("monitor_up_lrud", PeripheralType.Monitor), MonitorUpLUD("monitor_up_lud", PeripheralType.Monitor),
    MonitorUpRU("monitor_up_ru", PeripheralType.Monitor), MonitorUpLRU("monitor_up_lru", PeripheralType.Monitor),
    MonitorUpLU("monitor_up_lu", PeripheralType.Monitor), MonitorDown("monitor_down", PeripheralType.Monitor),
    MonitorDownR("monitor_down_r", PeripheralType.Monitor), MonitorDownLR("monitor_down_lr", PeripheralType.Monitor),
    MonitorDownL("monitor_down_l", PeripheralType.Monitor), MonitorDownD("monitor_down_d", PeripheralType.Monitor),
    MonitorDownUD("monitor_down_ud", PeripheralType.Monitor), MonitorDownU("monitor_down_u", PeripheralType.Monitor),
    MonitorDownRD("monitor_down_rd", PeripheralType.Monitor), MonitorDownLRD("monitor_down_lrd", PeripheralType.Monitor),
    MonitorDownLD("monitor_down_ld", PeripheralType.Monitor), MonitorDownRUD("monitor_down_rud", PeripheralType.Monitor),
    MonitorDownLRUD("monitor_down_lrud", PeripheralType.Monitor), MonitorDownLUD("monitor_down_lud", PeripheralType.Monitor),
    MonitorDownRU("monitor_down_ru", PeripheralType.Monitor), MonitorDownLRU("monitor_down_lru", PeripheralType.Monitor),
    MonitorDownLU("monitor_down_lu", PeripheralType.Monitor), AdvancedMonitor("advanced_monitor", PeripheralType.AdvancedMonitor),
    ...
    AdvancedMonitorDownLU("advanced_monitor_down_lu", PeripheralType.AdvancedMonitor), Speaker("speaker", PeripheralType.Speaker);
