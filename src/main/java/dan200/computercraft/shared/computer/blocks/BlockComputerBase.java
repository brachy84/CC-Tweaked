...
public abstract class BlockComputerBase extends BlockDirectional {
    ...
    @Override
    @Deprecated
    public final IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ,
    ...
    @Override
    public final void getDrops(@Nonnull NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, @Nonnull IBlockState state,
                               int fortune) {
        TileEntity tile = world.getTileEntity(pos);
        if (tile instanceof TileComputerBase) {
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        TileEntity tile = world.getTileEntity(pos);
        if (!world.isRemote && tile instanceof IComputerTile computer && stack.getItem() instanceof IComputerItem item) {
