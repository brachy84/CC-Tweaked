...
/**
 * An instance of {@link net.minecraft.inventory.Container} which provides a computer. You should implement this if you provide custom
 * computers/GUIs to interact with them.
 */
@FunctionalInterface
