...
public class PocketServerComputer extends ServerComputer implements IPocketAccess {
    ...
    public PocketServerComputer(World world, int computerID, String label, int instanceID, ComputerFamily family) {
        super(world, computerID, label, instanceID, family, ComputerCraft.terminalWidth_pocketComputer,
    ...
    public Entity getValidEntity() {
        ...
        } else if (m_entity instanceof EntityLivingBase living) {
    ...
    public int getLight() {
        ...
        return tag.hasKey(ItemPocketComputer.NBT_LIGHT, Constants.NBT.TAG_ANY_NUMERIC) ? tag.getInteger(ItemPocketComputer.NBT_LIGHT) : -1;
    }
    ...
    public void setLight(int colour) {
        ...
        if (colour >= 0 && colour <= 0xFFFFFF) {
            if (!tag.hasKey(ItemPocketComputer.NBT_LIGHT, Constants.NBT.TAG_ANY_NUMERIC) ||
                tag.getInteger(ItemPocketComputer.NBT_LIGHT) != colour) {
    ...
    public Map<ResourceLocation, IPeripheral> getUpgrades() {
        return m_upgrade == null ? Collections.emptyMap() :
               Collections.singletonMap(m_upgrade.getUpgradeID(), getPeripheral(ComputerSide.BACK));
    }
    ...
    public void broadcastState(boolean force) {
        ...
        if ((hasTerminalChanged() || force) && m_entity instanceof EntityPlayerMP player) {
